      ...
      <div className="flex flex-row xl:my-16 gap-30 max-lg:flex-col max-lg:gap-16 max-lg:items-center w-full">
        ...
        <div className="flex flex-col items-start max-lg:items-center w-full">
          <div className="flex flex-row max-lg:w-full max-lg:justify-center max-lg:mt-15">
            ...
            <OlaButton
              className="text-2xl max-lg:text-xl max-lg:w-[200px] max-lg:h-[60px]"
              variant="outline"
            >
              How To Join
            </OlaButton>
          ...
          <h2 className="text-primary text-5xl mt-6 mb-4 max-lg:text-3xl max-lg:text-4xl max-lg:text-center">
            How to Join Our Communities
          </h2>

          <p className="text-lg tracking-wide text-foreground mb-20 max-lg:text-base max-lg:text-center max-lg:mb-10 max-lg:w-[80%]">
        ...
        <div className="relative w-[900px] h-[550px] overflow-hidden rounded-3xl mt-[7%] max-lg:mb-[10%] max-lg:w-full max-lg:h-[400px] max-lg:h-[260px]">
